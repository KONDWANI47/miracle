...
async function loadDataFromServer() {
    try {
        ...
        const [registrations, payments, announcements, heroAnnouncements, gallery, userUploads, paymentSettings, testimonials, blogPosts, students] = await Promise.all([
            apiCall('/registrations'),
            apiCall('/payments'),
            apiCall('/announcements'),
            apiCall('/hero-announcements'),
            apiCall('/gallery'),
            apiCall('/user-uploads'),
            apiCall('/payment-settings'),
            apiCall('/testimonials'),
            apiCall('/blog-posts'),
            apiCall('/students')
        ]);

        // Store data in localStorage as backup and for offline access
        ...
        console.error('Failed to load data from server, using localStorage:', error);
  ...
  function displayRegistrations(registrations) {
    ...
    registrations.forEach((reg) => {
      ...
      row.innerHTML = `
        ...
        <td><span class="status-badge status-${(reg.paymentStatus || "pending").toLowerCase()}">${reg.paymentStatus || "Pending"}</span></td>
        <td><span class="status-badge status-${reg.status.toLowerCase().replace(" ", "-")}">${reg.status}</span></td>
        <td>
              ...
              <div class="details-section">
                ...
                <div class="details-grid">
                  ...
                  <div class="detail-item">
                    ...
                    <span>${escapeHtml(registration.parentName || "Not provided")}</span>
                  </div>
                  <div class="detail-item">
              ...
              <div class="details-section">
                ...
                <div class="details-grid">
                  <div class="detail-item">
                    ...
                    <span>${escapeHtml(registration.childName || "Not provided")}</span>
                  </div>
                  <div class="detail-item">
                    <strong>Child's Age:</strong>
                    <span>${registration.childAge} years old</span>
                  </div>
                  <div class="detail-item">
                    <strong>Age Group:</strong>
                    <span>${getAgeGroup(registration.childAge)}</span>
                  </div>
                </div>
              </div>
              ...
              <div class="details-section">
                ...
                <div class="details-grid">
                  ...
                  <div class="detail-item">
                    ...
                    <span>${new Date(registration.startDate).toLocaleDateString('en-US', { 
                      weekday: 'long', 
                      year: 'numeric', 
                      month: 'long', 
                      day: 'numeric' 
                  ...
                  <div class="detail-item">
                    ...
                    <span>${new Date(registration.registrationDate).toLocaleString('en-US', {
                      weekday: 'long',
                      year: 'numeric',
                      month: 'long',
                      day: 'numeric',
              ...
              <div class="details-section">
                ...
                <div class="details-grid">
                  <div class="detail-item">
                    ...
                    <span class="status-badge status-${(registration.paymentStatus || "pending").toLowerCase()}">${registration.paymentStatus || "Pending"}</span>
                  </div>
                  <div class="detail-item">
                    <strong>Registration Status:</strong>
                    <span class="status-badge status-${registration.status.toLowerCase().replace(" ", "-")}">${registration.status}</span>
                  </div>
                  ${relatedPayment ? `
                    <div class="detail-item">
              ...
              <div class="details-section">
                ...
                <div class="details-grid">
                  <div class="detail-item">
                    ...
                    <span>${getDaysSince(new Date(registration.registrationDate))} days</span>
                  </div>
                  <div class="detail-item">
                    <strong>Days Until Start Date:</strong>
                    <span>${getDaysUntil(new Date(registration.startDate))} days</span>
                  </div>
...
✓ Reset any linked registration payment status to "Pending"
✓ Clear all payment references
✓ Update analytics and reports
✓ Cannot be undone
